...
class MistralAgent(RespondAgent[ChatGPTAgentConfig]):
    def __init__(
        self,
        ...
        openai.api_key = openai_api_key or getenv("ANYSCALE_API_KEY")
    ...
    def get_chat_parameters(
        ...
        parameters["model"] = "mistralai/Mistral-7B-Instruct-v0.1"
    ...
    async def respond(
        ...
        try:
            ...
            return "I'm sorry, I didn't understand that. Could you repeat that?", False
